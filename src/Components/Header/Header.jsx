...
//                         <h1 className="mr-3 h-12 text-2xl text-sky-900 font-bold flex items-center">
//                             EleGance-Hub
//                             </h1>
//                     </Link>
            ...
            <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5">
                <div className="flex justify-between items-center mx-auto max-w-screen-xl">
                    ...
                    <div className="lg:hidden">
                        <button
                            onClick={toggleMenu}
                            className="block text-gray-800 focus:ring-4 focus:ring-gray-300 rounded-lg px-3 py-2 focus:outline-none"
                        >
                            <svg
                                className="h-6 w-6"
                                fill="none"
